 ...
 * </p>
 * <ul>
 *   <li>{@link thingML.impl.ArrayProxyEntryImpl#getIndex <em>Index</em>}</li>
...
public class ArrayProxyEntryImpl extends MinimalEObjectImpl.Container implements ArrayProxyEntry {
		...
		if (index != null && index.eIsProxy()) {
			...
			if (index != oldIndex) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ThingMLPackage.ARRAY_PROXY_ENTRY__INDEX, oldIndex, index));
			}
		}
		return index;
	}
	...
	public void setIndex(Expression newIndex) {
		...
		index = newIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.ARRAY_PROXY_ENTRY__INDEX, oldIndex, index));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ThingMLPackage.ARRAY_PROXY_ENTRY__INDEX:
