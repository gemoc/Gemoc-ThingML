...
public class GreaterOrEqualExpressionAdapter extends EObjectAdapter<GreaterOrEqualExpression> implements org.thingml.xtext.thingML.GreaterOrEqualExpression {
  ...
  public EClass eClass() {
    return org.thingml.xtext.thingML.ThingMLPackage.eINSTANCE.getGreaterOrEqualExpression();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.thingml.xtext.thingML.ThingMLPackage.GREATER_OR_EQUAL_EXPRESSION__LHS:
    		return getLhs();
    	case org.thingml.xtext.thingML.ThingMLPackage.GREATER_OR_EQUAL_EXPRESSION__RHS:
    		return getRhs();
    }
