...
public class ImportAdapter extends EObjectAdapter<Import> implements org.thingml.xtext.thingML.Import {
  ...
  public EClass eClass() {
    return org.thingml.xtext.thingML.ThingMLPackage.eINSTANCE.getImport();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.thingml.xtext.thingML.ThingMLPackage.IMPORT__IMPORT_URI:
    		return getImportURI();
    	case org.thingml.xtext.thingML.ThingMLPackage.IMPORT__FROM:
    		return getFrom();
    }
