...
public class LowerOrEqualExpressionAdapter extends EObjectAdapter<LowerOrEqualExpression> implements org.thingml.xthingmlmt.thingML.LowerOrEqualExpression {
  ...
  public EClass eClass() {
    return org.thingml.xthingmlmt.thingML.ThingMLPackage.eINSTANCE.getLowerOrEqualExpression();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.thingml.xthingmlmt.thingML.ThingMLPackage.LOWER_OR_EQUAL_EXPRESSION__LHS:
    		return getLhs();
    	case org.thingml.xthingmlmt.thingML.ThingMLPackage.LOWER_OR_EQUAL_EXPRESSION__RHS:
    		return getRhs();
    }
