...
public class ProtocolAdapter extends EObjectAdapter<Protocol> implements org.thingml.xthingmlmt.thingML.Protocol {
  ...
  public EClass eClass() {
    return org.thingml.xthingmlmt.thingML.ThingMLPackage.eINSTANCE.getProtocol();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.thingml.xthingmlmt.thingML.ThingMLPackage.PROTOCOL__NAME:
    		return getName();
    	case org.thingml.xthingmlmt.thingML.ThingMLPackage.PROTOCOL__ANNOTATIONS:
    ...
    if (baseClass == org.thingml.xthingmlmt.thingML.AnnotatedElement.class) {
    	switch (baseFeatureID) {
    		case org.thingml.xthingmlmt.thingML.ThingMLPackage.ANNOTATED_ELEMENT__ANNOTATIONS:
    			return org.thingml.xthingmlmt.thingML.ThingMLPackage.PROTOCOL__ANNOTATIONS;
    		default: return -1;
    	}
    }
