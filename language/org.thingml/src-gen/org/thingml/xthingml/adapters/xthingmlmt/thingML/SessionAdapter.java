...
public class SessionAdapter extends EObjectAdapter<Session> implements org.thingml.xthingmlmt.thingML.Session {
  ...
  public void setMaxInstances(final Expression o) {
    if (o != null)
    	adaptee.setMaxInstances(((org.thingml.xthingml.adapters.xthingmlmt.thingML.ExpressionAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.thingml.xthingmlmt.thingML.ThingMLPackage.eINSTANCE.getSession();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.thingml.xthingmlmt.thingML.ThingMLPackage.SESSION__NAME:
    		return getName();
    	case org.thingml.xthingmlmt.thingML.ThingMLPackage.SESSION__ANNOTATIONS:
    		return getAnnotations();
    	case org.thingml.xthingmlmt.thingML.ThingMLPackage.SESSION__INITIAL:
    		return getInitial();
    	case org.thingml.xthingmlmt.thingML.ThingMLPackage.SESSION__HISTORY:
    		return isHistory() ? Boolean.TRUE : Boolean.FALSE;
    	case org.thingml.xthingmlmt.thingML.ThingMLPackage.SESSION__SUBSTATE:
    		return getSubstate();
    	case org.thingml.xthingmlmt.thingML.ThingMLPackage.SESSION__MAX_INSTANCES:
