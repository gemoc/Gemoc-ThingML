...
public class StateContainerAdapter extends EObjectAdapter<StateContainer> implements org.thingml.xthingmlmt.thingML.StateContainer {
  ...
  public EClass eClass() {
    return org.thingml.xthingmlmt.thingML.ThingMLPackage.eINSTANCE.getStateContainer();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.thingml.xthingmlmt.thingML.ThingMLPackage.STATE_CONTAINER__NAME:
    		return getName();
    	case org.thingml.xthingmlmt.thingML.ThingMLPackage.STATE_CONTAINER__ANNOTATIONS:
    ...
    if (baseClass == org.thingml.xthingmlmt.thingML.AnnotatedElement.class) {
    	switch (baseFeatureID) {
    		case org.thingml.xthingmlmt.thingML.ThingMLPackage.ANNOTATED_ELEMENT__ANNOTATIONS:
    			return org.thingml.xthingmlmt.thingML.ThingMLPackage.STATE_CONTAINER__ANNOTATIONS;
    		default: return -1;
    	}
    }
